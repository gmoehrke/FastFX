...
/*!
 * FFXTrigMotion - Use the trig/wave functions to create motion that speeds up at the end-points and slows in the middle (or vice versa).  The method does not adjust
