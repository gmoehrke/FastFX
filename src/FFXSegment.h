/*
 *  Definition of FXSegment class for housing multiple effects in a single pixel array.  Each segment contains a FXFrameProvider to handle
 *  updating the range of pixels it "houses" as well as both a local and global FX dimmer to manage brightness.
 * 
 *  An FXController will always have at least 1 segment - the Primary segment.  This represents the entire array and is always considered to 
